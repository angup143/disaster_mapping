...
class UNet11Upsample(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=False):
        """
        :param num_classes:
        :param num_filters:
        ...
        self.center = DecoderBlockUpsample(256 + num_filters * 8, num_filters * 8 * 2, num_filters * 8)
        self.dec5 = DecoderBlockUpsample(512 + num_filters * 8, num_filters * 8 * 2, num_filters * 8)
        self.dec4 = DecoderBlockUpsample(512 + num_filters * 8, num_filters * 8 * 2, num_filters * 4)
        self.dec3 = DecoderBlockUpsample(256 + num_filters * 4, num_filters * 4 * 2, num_filters * 2)
        self.dec2 = DecoderBlockUpsample(128 + num_filters * 2, num_filters * 2 * 2, num_filters)
        self.dec1 = ConvRelu(64 + num_filters, num_filters)
...
class UNet16Upsample(nn.Module):
    def __init__(self, num_classes=1, num_filters=32, pretrained=False):
        """
        :param num_classes:
        :param num_filters:
        ...
        self.center = DecoderBlockUpsample(512, num_filters * 8 * 2, num_filters * 8)

        self.dec5 = DecoderBlockUpsample(512 + num_filters * 8, num_filters * 8 * 2, num_filters * 8)
        self.dec4 = DecoderBlockUpsample(512 + num_filters * 8, num_filters * 8 * 2, num_filters * 8)
        self.dec3 = DecoderBlockUpsample(256 + num_filters * 8, num_filters * 4 * 2, num_filters * 2)
        self.dec2 = DecoderBlockUpsample(128 + num_filters * 2, num_filters * 2 * 2, num_filters)
        self.dec1 = ConvRelu(64 + num_filters, num_filters)
        self.final = nn.Conv2d(num_filters, num_classes, kernel_size=1)
...
class UNet18Upsample(nn.Module):
    """
        UNet (https://arxiv.org/abs/1505.04597) with Resnet34(https://arxiv.org/abs/1512.03385) encoder
        Proposed by Alexander Buslaev: https://www.linkedin.com/in/al-buslaev/
        """
    ...
    def __init__(self, num_classes=1, num_filters=32, pretrained=False, is_deconv=True):
        ...
        # self.dec5 = DecoderBlock(512 + num_filters * 8, num_filters * 8 * 2, num_filters * 8, is_deconv)
        self.dec5 = DecoderBlockUpsample(512, num_filters * 8 * 2, num_filters * 8)
        self.dec4 = DecoderBlockUpsample(256 + num_filters * 8, num_filters * 8 * 2, num_filters * 8)
        self.dec3 = DecoderBlockUpsample(128 + num_filters * 8, num_filters * 4 * 2, num_filters * 2)
        self.dec2 = DecoderBlockUpsample(64 + num_filters * 2, num_filters * 2 * 2, num_filters * 2 * 2)
        self.dec1 = DecoderBlockUpsample(num_filters * 2 * 2, num_filters * 2 * 2, num_filters)
        self.dec0 = ConvRelu(num_filters, num_filters)
        self.final = nn.Conv2d(num_filters, num_classes, kernel_size=1)
...
class UNet34Upsample(nn.Module):
    """
        UNet (https://arxiv.org/abs/1505.04597) with Resnet34(https://arxiv.org/abs/1512.03385) encoder
        Proposed by Alexander Buslaev: https://www.linkedin.com/in/al-buslaev/
        """
